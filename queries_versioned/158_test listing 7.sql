...
Data source: 4
Created By: Admin
Last Update At: 2016-01-29T17:53:57.760289+00:00
*/
            ...
            FROM
              (SELECT FIRST(SPLIT(LAST(SPLIT(post_prop5, '/')), '-')) AS Listing,
               ...
               WHERE post_page_event = "0" /*Page View calls*/
                 ...
                 AND post_prop19 = 'listing' /* Counting Listings */ ) v /*ADDING ALL THE ACTIVE LISTINGS + INACTIVE LISTINGS WHICH HAVE ACTIVITY*/  JOIN 
