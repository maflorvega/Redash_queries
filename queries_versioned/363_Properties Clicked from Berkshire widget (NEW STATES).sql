/*
Name: Properties Clicked from Berkshire widget (NEW STATES)
Data source: 4
Created By: Admin
Last Update At: 2016-03-30T17:14:14.326681+00:00
*/
...
LEFT JOIN [djomniture:devspark.MG_Listing_Address_USA] AS MG_LA ON v.Listing = MG_LA.Listing_id
GROUP BY URL,
         Agent,
         Street_Address,
         City,
