/*
Name: Searches for London from Middle East by country
Data source: 4
Created By: Admin
Last Update At: 2016-01-29T15:45:16.182947+00:00
*/
...
WHERE R.region='middle_east'
  AND v.geo_country IN
    (SELECT country_code from djomniture:devspark.Regions)
