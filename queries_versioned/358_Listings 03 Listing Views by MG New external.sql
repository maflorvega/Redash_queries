/*
Name: Listings 03 Listing Views by MG New external
Data source: 4
Created By: Admin
Last Update At: 2016-03-29T18:13:42.016317+00:00
*/
SELECT v.mgid AS mgid,
       marketingGroup ,
       Amount_of_Listings,
       Views,
       Visits,
     ...
     (SELECT Click,
      ...
      FROM
        (SELECT 1 AS Click,
         ...
         FROM [djomniture:devspark.Old_External_Clicks]
